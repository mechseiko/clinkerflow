...
export const recommendations: Recommendation[] = [
  {
    ...
    lossMechanism: 'Packer Line 3 offline due to mechanical jam in the bag feeder magazine throat, resulting in direct loss of 0.80 Mta packing capacity.',
    causes: [
    ...
    expectedBenefit: '+0.80 Mta packing capacity recovery',
    operationalImpact: 'Restores Line 3 to design feed rate, clearing back-pressure in cement silos and reducing queue delays.',
    estimatedGain: 0.80,
    priorityRationale: 'Line 3 shutdown represents the largest individual capacity bottleneck on this shift, accounting for the majority of the packing stage loss.',
  },
  {
    id: 'r2',
    stageId: 'mill',
    ...
    operationalImpact: 'Reduces specific mill circulating load, shifting energy towards new feed comminution, yielding an estimated +0.55 Mta grinding capacity.',
    estimatedGain: 0.55,
  ...
  },
  {
    ...
    lossMechanism: 'Fluctuations in compressed air header pressure (down to 5.8 bar vs 6.5 bar target) causing bag clamp slips and sealing failures on Packer Line 2, leading to 0.40 Mta throughput loss.',
    causes: [
    ...
    expectedBenefit: '+0.40 Mta packing capacity recovery',
  ...
  },
  {
    ...
    operationalImpact: 'Resolves funnel-flow compaction risks and restores direct gravity feed to downstream packer lines, recovering 0.40 Mta.',
    estimatedGain: 0.40,
  ...
  },
  {
    ...
    operationalImpact: 'Restores Bay 2 processing speed, clearing the plant entrance queue and recovering 0.30 Mta of dispatch throughput.',
    estimatedGain: 0.30,
  ...
  },
  {
    ...
    lossMechanism: 'Packer Line 4 bag rejection rate at 3.2% due to physical wear on filling spout liner, causing product spill and sensor-based bag rejection (0.35 Mta loss).',
    causes: [
    ...
    operationalImpact: 'Reduces material recirculation and manual cleanup labour, recovering 0.35 Mta of net shippable cement bags.',
    estimatedGain: 0.35,
